...
// guardamos el path de la session
...
//guardamos cuando se hizo la ultima accion
app.use(function (req, res, next) {
    if (req.session.user != null) {
console.log('Time Passed init '+req.session.timepassed);
        if (req.session.timepassed == null) {
            console.log('No hay tiempo en la session')
        } else {
